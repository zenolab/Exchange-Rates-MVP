package com.exchange_rates.grd.exchangerates.screens.screens_rate.commodities;
 ...
 */
public class CommoditiesFragmentView extends Fragment implements RateContract.View {
    ...
    private CommoditiesPresenterImp presenter;

    public CommoditiesFragmentView() {
    ...
    private void initPresenter() {
        presenter = new CommoditiesPresenterImp();
        presenter.attachView(this);
        presenter.viewIsReady();
        presenter.loadData(Market.Commodities);
    }
