...
/**
 * Не имеет смысла наследоваться от базового фрагмента ,
 * потму что тогда не будет возможно точечно вносить измения
 */
public class IndexesFragmentView extends Fragment implements RateContract.View  {
    ...
    private IndexesPresenterImp presenter;


    public IndexesFragmentView() {
    ...
    private void initPresenter() {
        presenter = new IndexesPresenterImp();
        presenter.attachView(this);
        presenter.viewIsReady();
        presenter.loadData(Market.Indexes);
    }
