...
public class AllRatesFragmentView extends Fragment implements RateContract.View{

    private static final String LOG_TAG = AllRatesFragmentView.class.getName();
    ...
    private AllRatesPresenterImpl presenter;
    ...
    private void initPresenter() {
        presenter = new AllRatesPresenterImpl();
        presenter.attachView(this);
        presenter.viewIsReady();
        presenter.loadData(Market.AllData);
    }
    //----------------------------------------------------------------------------------------------
    @Override
